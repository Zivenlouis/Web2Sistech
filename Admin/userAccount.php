            ...
            <div class="card-body">
              ...
              <?php
                ...
                if(isset($_POST['submit'])) {
                  ...
                  if(isset($_POST['id'])) {
                    $id = $_POST['id'];
                    if(updateUser($id, $firstName, $lastName, $email, $password, $nim, $class, $line, $major, $intake, $active)) {
                    ...
                    if(insertUser($firstName, $lastName, $email, $password, $nim, $class, $line, $major, $intake, $active)) {
