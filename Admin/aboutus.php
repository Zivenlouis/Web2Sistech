            ...
            <div class="card-body">
              ...
              if($arr['about_content'] != '') { ?> 
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea style="height: 200px;" class="form-control" required  id="aboutDescription" name="description" placeholder="Description" style="color: #ffff"><?= $arr['about_content']; ?></textarea>
                  </div>
                </div>
              <?php } 
              if ($arr['about_image'] != '') { ?> 
